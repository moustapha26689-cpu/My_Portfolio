      ...
      <div className="text-center px-4 relative z-10 max-w-4xl mx-auto py-12">
        ...
        >
          ...
          >
            ...
            <span className="hidden sm:inline">{tContact('emailLabel') || 'Email'}</span>
          </motion.a>
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center space-x-3 px-6 py-3 bg-[#0077b5] hover:bg-[#005885] text-white rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
          >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center space-x-3 px-6 py-3 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
